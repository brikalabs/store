...
import { fetchLocale } from "@/server/locale";
...
export const Route = createRootRoute({
  // SSR reads the theme-mode cookie (matching data-mode, no mismatch) and the Accept-Language locale.
  loader: async () => ({ theme: await fetchThemeMode(), locale: await fetchLocale() }),
  head: () => ({
    meta: [
      { charSet: "utf-8" },
