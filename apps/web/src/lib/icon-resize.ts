 ...
 * upload - so a user can pick a large photo and we still send (and store) a small logo. A thin
 * domain wrapper over the {@link image} pipeline; the server validates the result as the backstop.
 */
